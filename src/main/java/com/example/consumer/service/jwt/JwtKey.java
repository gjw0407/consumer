...
public class JwtKey {
	...
	private static final Map <String, String> SECRET_KEY_SET = new HashMap<String, String>() {{
			put("key1", "SCHDULEKEYFORSECURITYSCHDULEKEYFORSECURITYSCHDULEKEYFORSECURITY");
			put("key2", "CHDULEKEYFORSECURITYSCHDULEKEYFORSECURITYSCHDULEKEYFORSECURITYS");
			put("key3", "HDULEKEYFORSECURITYSCHDULEKEYFORSECURITYSCHDULEKEYFORSECURITYSC");
		}};
